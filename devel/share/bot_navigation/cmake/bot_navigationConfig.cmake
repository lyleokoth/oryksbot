...
if("TRUE" STREQUAL "TRUE")
  set(bot_navigation_SOURCE_PREFIX /home/lyle/oryksbot/src/bot_navigation)
  set(bot_navigation_DEVEL_PREFIX /home/lyle/oryksbot/devel)
  ...
  set(bot_navigation_INSTALL_PREFIX /home/lyle/oryksbot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lyle/oryksbot/src/bot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(bot_navigation_EXPORTED_TARGETS ${${bot_navigation_dep}_EXPORTED_TARGETS})
endforeach()
